...
- Limit yourself to 2-3 RAG searches and 2-3 web searches maximum
- Once you have enough information to fill the threat brief schema, STOP searching and produce the brief
- Do not search for information you already have
- Quality over quantity - better to produce a good brief than over-research
